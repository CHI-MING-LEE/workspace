...
class Data():
    ...
    def get_adj(self, name):
        ...
        item = self.get(name)
        ratio1 = self.get('otc_cap_divide_ratio')
        ratio2 = self.get('twse_cap_divide_ratio')
        ratio3 = self.get('otc_divide_ratio')
        ratio4 = self.get('twse_divide_ratio')
